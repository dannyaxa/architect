...
// template_formation_tmpl reads file data from disk. It returns an error on failure.
func template_formation_tmpl() (*asset, error) {
	path := "/Users/david/Code/convox/architect/template/formation.tmpl"
	name := "template/formation.tmpl"
